...
- [x] 1.5 Run `openspec validate` and existing linters/tests.

## 2. Validation

- [x] 2.1 `openspec validate add-distro-aware-pam-wiring --strict`
- [x] 2.2 `cargo fmt && cargo clippy -- -D warnings`
- [x] 2.3 Targeted script/unit tests (if added) or dry-run script invocation per distro matrix.
